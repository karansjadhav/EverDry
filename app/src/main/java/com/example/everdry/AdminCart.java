...
public class AdminCart extends AppCompatActivity {
    ...
    MyAdapterAdminProduct myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Admin Cart");
        ...
        list = new ArrayList<>();
        myAdapter = new MyAdapterAdminProduct(this,list);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot : snapshot.child(uid).child("products").getChildren()) {
                    for(DataSnapshot dataSnapshot2 : dataSnapshot.getChildren()) {
                        AdminProducts p = dataSnapshot2.getValue(AdminProducts.class);
                        list.add(p);
                    }
                }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AdminCart.this, AdminHome.class);
